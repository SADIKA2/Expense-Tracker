...
<body>
 ...
 ?>          
             ...
             <li>
                            ...
                            <li>
                                <a class="active-menu" href="income_report.php "><i class="fa fa-file-code-o"></i>Income Report</a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Income Details <cdiv class="pull-right">Filter Report using the search</cdiv> 
                        </div>
  ...
  WHERE (s.income_category_id>0 )");
              ...
              <td>
              <button type="button" class="btn btn-danger btn-xs" data-target="#modal_delete<?php echo $row['income_id']?>"data-toggle='modal'><span class='glyphicon glyphicon-trash'></span> Delete</button>
             </td>

             <div class="modal fade" id="modal_delete<?php echo $row['income_id']?>" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <center><h4>Are you sure you want to delete this income entry?</h4></center>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-primary" data-dismiss="modal">No</button>
                  <a type="button" class="btn btn-danger" href="income_delete.php?income_id=<?php echo $row['income_id']?>">Yes</a>
                </div>
              </div>
            </div>
          </div>  
